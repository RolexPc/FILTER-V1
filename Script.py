...
• ᴘᴇʀᴍᴀɴᴇɴᴛ ᴅᴍ ʟɪɴᴋ : <a href=https://t.me/TGxIRFAN>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a></b>"""
    ...
    AUTOFILTER_TXT = """<b>
 Bro Or Sis, ഈ ഒരു ബോട്ട് പുതിയതായിട്ട് വരുന്ന തിയേറ്റർ പ്രിന്റ് മാത്രം ലഭിക്കുന്ന ബോട്ടാണ്ണ് ആണ് , ബോട്ട് Owner ഡെ പർമ്മിഷൻ ഇല്ലാതെ മറ്റു ഗ്രൂപ്പുകളിൽ ഒന്നും ഈ ബോട്ടിനെ യൂസ് ചെയ്യാൻ കഴിയില്ല..!!  🤗⚠

️📌 𝗔𝗻𝘆 𝗛𝗲𝗹𝗽 𝗣𝗹𝗲𝗮𝘀𝗲 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗔𝗱𝗺𝗶𝗻 : @ARAKAL_THERAVAD_MOVIES_02_bot</b>"""
   
    EXTRA_TXT = """<b>കുറെ പ്രത്യേകതയുള്ള ബോട്ടാണ് ഐശ്വര്യം, ⚔

1. ലോകത്തിലെ ഏറ്റവും വേഗത്തിൽ ഓടുന്ന ബോട്ട് ഇതാണ് അതിനൊരു സംശയവും വേണ്ട ❤️‍🔥 

2. ഐശ്വര്യം ഉണ്ടാക്കിയിരിക്കുന്ന കോഡ് തികച്ചും റീ റൈറ്റ് ചെയ്തിരിക്കുന്നതാണ് അതുമാത്രമല്ല ഇതിനെ ഹോസ്റ്റ് ചെയ്തിരിക്കുന്നത് വി പി എസിൽ ആണ്  അതുകൊണ്ട് ഇത് കുതിരനെ കാട്ടിലും  വേഗത്തിലോടും

3. അങ്ങനെ വളരെയധികം ഫ്യൂച്ചേഴ്സ് ആഡ് ചെയ്തിട്ടുണ്ട് 😁🤗

𝑻𝒉𝒆 𝑨𝒊𝒔𝒉𝒘𝒂𝒓𝒚, ⚔ 𝑰𝒔 𝑨 𝑹𝒂𝒕𝒉𝒆𝒓 𝑺𝒑𝒆𝒄𝒊𝒂𝒍 𝑩𝒐𝒂𝒕

1. 𝑻𝒉𝒊𝒔 𝑰𝒔 𝑻𝒉𝒆 𝑭𝒂𝒔𝒕𝒆𝒔𝒕 𝑩𝒐𝒂𝒕 𝑰𝒏 𝑻𝒉𝒆 𝑾𝒐𝒓𝒍𝒅 𝑾𝒊𝒕𝒉𝒐𝒖𝒕 𝑨 𝑫𝒐𝒖𝒃𝒕 ❤️‍🔥     

2. 𝑻𝒉𝒆 𝑪𝒐𝒅𝒆 𝑻𝒉𝒂𝒕 𝑴𝒂𝒌𝒆𝒔 𝑨𝒊𝒔𝒉𝒘𝒂𝒓𝒚 𝑰𝒔 𝑪𝒐𝒎𝒑𝒍𝒆𝒕𝒆𝒍𝒚 𝑹𝒆𝒘𝒓𝒊𝒕𝒕𝒆𝒏 𝑨𝒏𝒅 𝑵𝒐𝒕 𝑶𝒏𝒍𝒚 𝑰𝒔 𝑰𝒕 𝑯𝒐𝒔𝒕𝒆𝒅 𝑶𝒏 𝑯𝑬𝑹𝑲𝑼𝑶 𝑺𝒐 𝑰𝒕 𝑴𝒂𝒌𝒆𝒔 𝑻𝒉𝒆 𝑯𝒐𝒓𝒔𝒆 𝑾𝒊𝒍𝒅 𝑨𝒏𝒅 𝑭𝒂𝒔𝒕.
